...
import type { PaperSize, Point, Polygon, Session, PhotoStation, PhotoStationSuggestion } from '@/types'
...
function usePhotoStations({
  ...
  }, [sessionId, setError, setLocalCorners, setPaperSize, setSession])
  ...
  }, [handleReuseStation, stationSuggestions])
  ...
  }, [paperSize, refreshStationSuggestions, sessionId, setError, setLocalCorners, setSession])
